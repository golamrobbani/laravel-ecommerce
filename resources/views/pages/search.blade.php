...
@section("contentheader_title", "Search")
@section("contentheader_description", "Search")
                                                                ...
                                                                <div class="action">
                                                                    <ul class="list-unstyled">
                                                                        <li class="add-cart-button btn-group">
                                                                            <button data-toggle="tooltip" class="btn btn-primary icon" type="button" title="Wishlist"  ng-click="addToWishlist({{json_encode($product)}}, 1)"> <i class="fa fa-heart"></i> </button>
                                                                        </li>
